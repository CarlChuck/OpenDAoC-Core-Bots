...
namespace DOL.GS.Scripts
{
    public class MimicNPC : GameNPC, IGamePlayer
    {
        ...
        #region IGamePlayer — Explicit Interface Implementations
        ...
        public MimicNPC(eMimicClass cClass, byte level, eRace race, eGender gender, string name, eSpecType spec = eSpecType.None)
        {
            _dummyClient = new DummyClient(GameServer.Instance);
            _dummyLib = new DummyPacketLib();
            ...
            MimicSpec = MimicSpec.GetSpec(cClass, spec);
            SetCharacterClass((int)cClass);
            SetRaceAndName(race, gender, name);
            SetBrain(cClass);
            SetLevel(level);
        ...
        public void SetRaceAndName(eRace race, eGender gender, string name)
        {
            PlayerRace playerRace = null;

            foreach (PlayerRace r in PlayerRace.AllRaces)
            {
                if (r.ID == race)
                {
                    playerRace = r;
            ...
            Dictionary<eStat, int> statDict;
            GlobalConstants.STARTING_STATS_DICT.TryGetValue(race, out statDict);
        ...
        /// </summary>
        private long m_damageRvRMemory;
        public new long DamageRvRMemory
        {
        ...
        // FIXME: IPlayerStatistics removed from codebase
        ...
        public new int CalculateCastingTime(SpellLine line, Spell spell)
        {
            int castTime;
        ...
        public new void SetControlledBrain(IControlledBrain controlledBrain)
        {
