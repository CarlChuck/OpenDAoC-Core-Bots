...
namespace DOL.GS.Scripts
{
    ...
    public static class MimicManager
    {
        ...
        public static MimicNPC GetMimic(eMimicClass charClass, byte level, eRace race, eGender gender, string name, eSpecType spec = eSpecType.None, bool preventCombat = false)
        {
            if (charClass == eMimicClass.None)
                return null;

            MimicNPC mimic = new MimicNPC(charClass, level, race, gender, name, spec);
